...
export default function page() {
  ...
  <div id="content">
    ...
    {/* <!-- First div --> */}
    <div className="container-fluid" style={{backgroundColor:'#ceecf7', width:'100%', padding:'6% 10% 8%'}}>
      <div className="row">
            ...
            <div className="card shadow p-3 mb-5 bg-white rounded">
              <div className="card-body" style={{height: '15rem'}}>
                ...
                <a  href="https://www.healthline.com/nutrition/best-exercise-for-weight-loss#cycling"
                  className="btn btn-down" style={{backgroundColor: '#07A6C2', color: 'white'}}>Click here</a>
              </div>
            </div>
          </div>
          <div className="col-lg-4 col-md-12 col-sm-12" style={{paddingBottom: '3%'}}>
          ...
          <div className="col-lg-4 col-md-12 col-sm-12" style={{paddingBottom: '3%'}}>
            <div className="card shadow p-3 mb-5 bg-white rounded">
              <div className="card-body" style={{height: '15rem'}}>
                ...
                <a href='https://www.healthline.com/nutrition/27-health-and-nutrition-tips' 
                  className="btn btn-down" style={{backgroundColor: '#07A6C2', color: 'white'}}>Click here</a>
              </div>
            </div>
          </div>
    ...
    <div className="container-fluid" style={{backgroundColor: '#b6ffe9', padding: '4% 0 0'}}>
      ...
      <div className="row" style={{alignItems: 'center'}}>
        <div className="col-lg-4 col-md-12 col-sm-12" style={{height: '28rem'}}>
          <div className="price_card"
            style={{height: '25rem', width: '18rem', background:'linear-gradient(135deg,rgb(70, 188, 243),rgb(145, 181, 236))', marginLeft:'8rem', marginTop: '2rem', borderRadius: '10%'}}>
        ...
        <div className="col-lg-4 col-md-12 col-sm-12" style={{height: '28rem'}}>
          <div className="price_card"
            style={{height: '25rem', width: '18rem', background:'linear-gradient(135deg,rgb(70, 188, 243),rgb(145, 181, 236))' ,marginLeft:'8rem', marginTop: '2rem', borderRadius: '10%', paddingRight: '0rem'}}>
      ...
      <footer
        ...
        Made by 👨‍⚕️ Hardik Hans & Harsh Jain
      </footer>
    </div>
  </div>
